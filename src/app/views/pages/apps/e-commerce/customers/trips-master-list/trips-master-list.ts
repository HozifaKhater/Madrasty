...
export class TripsComponent implements OnInit, OnDestroy {
	...
	editCustomer(trips: trips, TripsDataService: TripsDataService) {
		...
		this.TripsDataService.GetAlltrips_with_id(trips.trip_id).subscribe(data => this.trips_info = data,
			...
			() => {
				console.log("this.students_info", this.trips_info);
				for (let item of this.trips_info) {
					console.log("hhhhhh", item.trip_id)
					
					console.log('testdepname', item.trip_date);

					this.TripsDataService.trip_id = item.trip_id;
					this.TripsDataService.trip_date = item.trip_date;
					this.TripsDataService.trip_time = item.trip_time;
				};
				console.log('Component A is clicked!!', this.TripsDataService.trip_date);
	...
	deleteCustomer(trips: trips, TripsDataService: TripsDataService) {
