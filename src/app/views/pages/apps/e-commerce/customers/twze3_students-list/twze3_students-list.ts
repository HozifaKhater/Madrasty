...
@Component({
	...
	selector: 'kt-twze3_students-list',
	templateUrl: './twze3_students-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class Twze3StudentsListComponent implements OnInit, OnDestroy {
	// Table fields
	classes: Classes[];
	selectedclass: any;
    ...
    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'student_id', 'student_name', 'class_name','actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	get_Twze3_students(StudentDataService: StudentDataService) {

        this.StudentDataService.GetAllStudent_of_level(this.AbsenceDataService.grade_id).subscribe(data => this.ELEMENT_DATA = data,
			error => console.log(error),
			() => { this.dataSource = new MatTableDataSource(this.ELEMENT_DATA), console.log("ffff", this.ELEMENT_DATA) }
		); }
	/**
