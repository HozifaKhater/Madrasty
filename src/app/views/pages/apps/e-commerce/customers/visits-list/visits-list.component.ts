...
export class visitsComponent implements OnInit, OnDestroy {
    ...
    Element1: [{ id: "1" },
        { id: "2" }];
    displayedColumns = ['select', 'visit_id', 'visit_type_name','visit_date', 'actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
  ...
  //  get_subjects(Visit_typesDataService: Visit_typesDataService) {
		//this.Visit_typesDataService.GetAllVisit_types().subscribe(data => this.visit_types = data,
		//	error => console.log(error),
		//	() => console.log("ok",this.visit_types));
		// }
	/**
	...
	subjects_info: any[];
    edit_subject(Visits: Visits, VisitsDataService: VisitsDataService ) {

		//this.DepartmentService.data = Number(customer.dep_id)
		//console.log('CUSTOMER ID', Number(customer.dep_id));
        console.log('visit_type ID', Visits.visit_id);
        ...
        this.VisitsDataService.GetAllvisit_with_id(Visits.visit_id).subscribe(data => this.visit_types_info = data,
            ...
            () => {
                console.log("visitinfo",this.visit_types_info)
                ...
                console.log('Component A is clicked!!', this.VisitsDataService.visit_type_name);
    ...
    delete_subject(Visits: Visits, VisitsDataService: VisitsDataService) {
	
        console.log('CUSTOMER ID', Visits.visit_id);
        this.VisitsDataService.deletevisits(Number(Visits.visit_id)).subscribe(res => {
           // this.get(Visit_typesDataService);
            
			alert(res.toString());
		
		})
      //  this.get_subjects(Visit_typesDataService);
	}
