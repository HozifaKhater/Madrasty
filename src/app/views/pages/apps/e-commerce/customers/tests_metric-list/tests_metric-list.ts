...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_tests(Tests_metricDataService);

	}
	get_tests(Tests_metricDataService: Tests_metricDataService) {
	...
	Tests_info: any [];
	editCustomer(customer: Tests_metric, Tests_metricDataService: Tests_metricDataService ) {
		...
		this.Tests_metricDataService.GetAllTests_metric_with_id(customer.tests_id).subscribe(data => this.Tests_info = data,
			...
			() => {
				for (let item of this.Tests_info) {
					...
					console.log('testdepname', item.tests_type);
				...
				console.log('Component A is clicked!!', this.Tests_metricDataService.tests_id);
	...
	deleteCustomer(customer: Tests_metric, Tests_metricDataService: Tests_metricDataService) {
	
		console.log('CUSTOMER ID', customer.tests_id);
