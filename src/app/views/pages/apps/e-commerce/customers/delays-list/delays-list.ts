...
@Component({
	...
	selector: 'kt-delays-list',
	templateUrl: './delays-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class DelaysListComponent implements OnInit, OnDestroy {
	// Table fields
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	get_delays(DelaysDataService: DelaysDataService) {
		...
		this.DelaysDataService.GetAllDelays().subscribe(data => this.ELEMENT_DATA = data,
