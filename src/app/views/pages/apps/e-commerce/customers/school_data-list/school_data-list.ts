...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_school_data(School_dataDataService);
	}
	get_school_data(School_dataDataService: School_dataDataService) {
		this.School_dataDataService.GetAllSchool_data().subscribe(data => this.ELEMENT_DATA = data,
	...
	edit_corridor(corridor: School_data, School_dataDataService: School_dataDataService ) {

		//this.DepartmentService.data = Number(customer.dep_id)
		//console.log('CUSTOMER ID', Number(customer.dep_id));
		console.log('emp ID', corridor.school_id);
	
		this.School_dataDataService.GetAllSchool_data_with_id(corridor.school_id).subscribe(data => this.school_data_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.School_dataDataService);
	...
	delete_corridor(corridor: School_data, School_dataDataService: School_dataDataService ) {
	
		console.log('CUSTOMER ID', corridor.school_id);
