...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
        ...
        this.Visit_typesDataService.GetAllVisit_types().subscribe(data => this.visit_types = data,
            error => console.log("erorrrrrrrrrrr",error),
	...
	subjects_info: any[];
    edit_subject(Visit_types: Visit_types, Visit_typesDataService: Visit_typesDataService ) {

		//this.DepartmentService.data = Number(customer.dep_id)
		//console.log('CUSTOMER ID', Number(customer.dep_id));
        console.log('visit_type ID', Visit_types.visit_type_id);
        ...
        this.Visit_typesDataService.GetAllvisit_types_with_id(Visit_types.visit_type_id).subscribe(data => this.visit_types_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.Visit_typesDataService.visit_type_name);
    ...
    delete_subject(Visit_types: Visit_types, Visit_typesDataService: Visit_typesDataService) {
	
        console.log('CUSTOMER ID', Visit_types.visit_type_id);
