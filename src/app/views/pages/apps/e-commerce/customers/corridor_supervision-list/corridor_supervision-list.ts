...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_Corridorsupervision(Corridor_supervisionDataService);

	}
	get_Corridorsupervision(Corridor_supervisionDataService: Corridor_supervisionDataService) {

		this.Corridor_supervisionDataService.GetAllCorridor_supervision().subscribe(data => this.ELEMENT_DATA = data,
	...
	editCustomer(customer: Corridor_supervision, Corridor_supervisionDataService: Corridor_supervisionDataService ) {
		...
		console.log('CUSTOMER ID', customer.supervision_id);
		this.Corridor_supervisionDataService.GetAllCorridor_supervision_with_id(customer.supervision_id).subscribe(data => this.corridor_supervision_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.Corridor_supervisionDataService.corridor_id);
	...
	deleteCustomer(customer: Corridor_supervision, Corridor_supervisionDataService: Corridor_supervisionDataService) {
