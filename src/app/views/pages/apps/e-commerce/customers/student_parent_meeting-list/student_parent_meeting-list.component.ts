...
export class student_parent_meetingListComponent implements OnInit, OnDestroy {
    ...
    Element1: [{ id: "1" },
        { id: "2" }];
    displayedColumns = ['select', 'id', 'student_name', 'date', 'actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
    ...
    editCustomer(student_parent_meeting: student_parent_meeting ) {
        ...
        console.log('emp ID', student_parent_meeting.id);
        ...
        this.student_parent_meetingDataService.GetAllstudent_parent_meeting_with_id(student_parent_meeting.id).subscribe(data => this.departments_info = data,
			...
			() => {
                ...
                console.log('Component A is clicked!!', this.student_parent_meetingDataService.id);
	...
	deleteCustomer(customer: CustomerModel) {
        ...
        this.student_parent_meetingDataService.deletestudent_parent_meeting(Number(customer.dep_id)).subscribe(res => {
            this.get_student_parent_meeting();
			alert(res.toString());
