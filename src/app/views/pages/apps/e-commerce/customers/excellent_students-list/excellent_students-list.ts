...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_excstudents(Excellent_studentsDataService);

	}
	get_excstudents(Excellent_studentsDataService: Excellent_studentsDataService) {

		this.Excellent_studentsDataService.GetAllExcellent_students().subscribe(data => this.ELEMENT_DATA = data,
	...
	editCustomer(customer: Excellent_students, Excellent_studentsDataService: Excellent_studentsDataService ) {
		...
		this.Excellent_studentsDataService.GetAllExcellent_students_with_id(customer.exc_stu_id).subscribe(data => this.excstudents_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.Excellent_studentsDataService.exc_stu_id);
	...
	deleteCustomer(customer: Excellent_students, Excellent_studentsDataService: Excellent_studentsDataService) {
	
		console.log('CUSTOMER ID', customer.exc_stu_id);
