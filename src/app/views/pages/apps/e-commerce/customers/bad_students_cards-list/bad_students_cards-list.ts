...
@Component({
	...
	selector: 'kt-BadStudentsCards-list',
	templateUrl: './bad_students_cards-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class BadStudentsCardsListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'student_card_id', 'student_name', 'bad_da3f', 'bad_da3f_reasons', 'bad_result', 'actions'];
