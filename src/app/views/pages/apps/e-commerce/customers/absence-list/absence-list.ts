...
export class AbsenceListComponent implements OnInit, OnDestroy {
    ...
    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'absence_id', 'absence_lev', 'absence_class', 'absence_date','absence_student_name', 'actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_absence(AbsenceDataService);

	}
	get_absence(AbsenceDataService: AbsenceDataService) {
	...
	ngOnInit() {
		this.AbsenceDataService.bClickedEvent
			.subscribe((data: string) => {
				...
				//this.StudentDataService.GetAllStudent_of_level(this.AbsenceDataService.grade_id).subscribe(data => this.Student = data,
				//	error => console.log(error),
				//	() => console.log("department dropdown", this.Student));
	...
	Absence_info: any [];
	editCustomer(customer: Absence, AbsenceDataService: AbsenceDataService ) {
		...
		this.AbsenceDataService.GetAllAbsence_with_id(customer.absence_id).subscribe(data => this.Absence_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.AbsenceDataService.absence_id);
	...
	deleteCustomer(customer: Absence, AbsenceDataService: AbsenceDataService) {
	
		console.log('CUSTOMER ID', customer.absence_id);
