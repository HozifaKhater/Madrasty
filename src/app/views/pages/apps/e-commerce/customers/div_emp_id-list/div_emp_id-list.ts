...
@Component({
    ...
    selector: 'kt-div_emp-list',
    templateUrl: './div_emp_id-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class div_empListComponent implements OnInit, OnDestroy {
	// Table fields
	classes: Classes[];
	selectedclass: any;
    ...
    Element1: [{ id: "1" },
        { id: "2" }];
    displayedColumns = ['select', 'div_id', 'div_name','actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	get_Twze3_students() {
        ...
        this.basic_dataDataService.GetAlldiv_with_emp_id(this.basic_dataDataService.emp_id).subscribe(data => this.ELEMENT_DATA = data,
			error => console.log(error),
			() => { this.dataSource = new MatTableDataSource(this.ELEMENT_DATA), console.log("ffff", this.ELEMENT_DATA) }
		); }
	/**
