...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	constructor(
		...
		this.get_nchra(NchraDataService);

	}
	get_nchra(NchraDataService: NchraDataService) {
	...
	editCustomer(customer: Nchra, NchraDataService: NchraDataService ) {
		...
		this.NchraDataService.GetAllNchra_with_id(customer.nchra_id).subscribe(data => this.Nchra_info = data,
			error => console.log("errorrrrrrrrrrr"),
			() => {
				for (let item of this.Nchra_info) {
					console.log(item.nchra_id)
				...
				console.log('Component A is clicked!!', this.NchraDataService.nchra_id);
	...
	deleteCustomer(customer: Nchra, NchraDataService: NchraDataService) {
	
		console.log('CUSTOMER ID', customer.nchra_id);
		this.NchraDataService.deleteNchra(Number(customer.nchra_id)).subscribe(res => {
			this.get_nchra(NchraDataService);
			alert(res.toString());
