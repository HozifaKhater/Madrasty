...
@Component({
	...
	selector: 'kt-corridors-list',
	templateUrl: './corridors-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class CorridorListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'corridor_id', 'corridor_name', 'corridor_desc', 'actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	CorridorsMaster: CorridorsMaster[];
	...
	get_corridros(corridorsDataService) {
		corridorsDataService.GetAllCorridors().subscribe(data => this.ELEMENT_DATA = data,
	...
	corridor_info: any [];
	edit_corridor(corridor: corridor, corridorsDataService: corridorsDataService ) {
	...
	delete_corridor(corridor: corridor, corridorsDataService: corridorsDataService ) {
