...
export class UsersListComponent implements OnInit, OnDestroy {
	...
	add_maint() {
		...
		var val = {
			maint_date: moment(this.maint_date).format('DD/MM/YYYY'),
	...
	ngOnInit() {
		...
		this.maint_id = this.maint_id;
		this.maint_date = this.maint_date;
		this.maint_type = this.maint_type;
		this.maint_loc = this.maint_loc;
		this.maint_work = this.maint_work;
		this.maint_notes = this.maint_notes;
