...
export class ExpansionPanelComponent implements OnInit {
    foods = [
        { value: 'steak-0', viewValue: 'الحاله1' },
        { value: 'pizza-1', viewValue: 'الحاله2' },
        { value: 'tacos-2', viewValue: 'الحاله3' }
    ];
	exampleBasicPanel;
    ...
    constructor(private EmployeeDataService: EmployeeDataService, private DepartmentDataService: DepartmentDataService) {
