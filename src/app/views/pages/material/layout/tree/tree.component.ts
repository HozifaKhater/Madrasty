...
export class TreeComponent implements OnInit {
	...
	days = [
		{ value: 'steak-0', viewValue: 'يوم1' },
		{ value: 'pizza-1', viewValue: 'يوم2' },
		{ value: 'tacos-2', viewValue: 'يوم3' }
	];
	weeks = [
		{ value: 'steak-0', viewValue: 'اسبوع1' },
		{ value: 'pizza-1', viewValue: 'اسبوع2' },
		{ value: 'tacos-2', viewValue: 'اسبوع3' }
	];
	ngOnInit() {
